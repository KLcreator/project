...
def task_create():
    ...
    return render_template('task_form.html', user=get_current_user(), editing=False)
...
def task_edit(id):
    ...
    return render_template('task_form.html', task=task, user=get_current_user(), editing=True)
